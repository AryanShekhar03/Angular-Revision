...
export class UpdateComponent implements OnInit {
 ...
 Emp:any;
  ...
  constructor(private formBuilder:FormBuilder,private edit: UserService,private snackBar:MatSnackBar,private router: Router,public dialogRef: MatDialogRef<UpdateComponent>, @Inject(MAT_DIALOG_DATA) public data:any) { 
    this.empID=data.id
    this.name=data.name
...
onCheckboxChange(event:any) {
  ...
  onSubmit(empID:any) {
    ...
    if (this.UpdateForm.valid){
      ...
      this.edit.editemployee(reqdata,this.empID).subscribe((result:any)=>{
        console.log(result)
